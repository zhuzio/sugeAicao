...
class Weixinpay {
	...
	private $config = array(
		'APPID' => 'wx6cd6a382dde4b1b7', // 微信支付APPID
		'MCHID' => '1431254302', // 微信支付MCHID 商户收款账号
		'KEY' => '6875faaab81cc96b57cbe57add4c9cc8', // 微信支付KEY
		'APPSECRET' => '', //公众帐号secert
		'NOTIFY_URL' => 'http://yuyulu.cn/Wechat/Index/notify', // 接收支付状态的连接  改成自己的域名
	);
	...
	public function getParameters() {
		...
		if (!isset($_GET['code'])) {
			...
			// 返回的url
			$redirect_uri = U('Wechat/test/pay', '', '', true);
